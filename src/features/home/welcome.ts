        ...
        <div class="nox-welcome-hero">
          <div>
            ...
            <p class="nox-welcome-copy">
              Sign in with a Nostr extension for the cleanest flow, use a local private key if you need direct control,
              or skip straight to the global timeline and watch the network in motion.
            </p>
          </div>
