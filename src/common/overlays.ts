export function setupImageOverlay(): void {
  ...
  const overlayImg: HTMLImageElement | null = document.getElementById(
    'image-overlay-img',
  ) as HTMLImageElement;
  const overlayCount: HTMLElement | null = document.getElementById(
    'image-overlay-count',
  );
  ...
  const prevBtn: HTMLElement | null =
    document.getElementById('image-overlay-prev');
  const nextBtn: HTMLElement | null =
    document.getElementById('image-overlay-next');
